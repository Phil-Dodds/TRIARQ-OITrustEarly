...
} from "./chunk-HF6M5R4C.js";
import {
  transition
} from "./chunk-WOWOWLRW.js";
import {
  getTimeGivenProgression
} from "./chunk-ZNWM5CSD.js";
import "./chunk-23NJ23HC.js";
import {
  isRTL
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-020f5464-56HQXSM4.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-dfea3607-RFFVX2D2.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-a52daa3a-ZXD45OI7.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-6107a37c-INFPV2BW.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-52278bd7-PW62EXBA.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-dd40d69f-Y4L4ZMTM.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var Content = class {
  ...
  render() {
    ...
    } }, h("div", { key: "8006c4a10d8f7dc83c646246961d018a8097236e", ref: (el2) => this.backgroundContentEl = el2, id: "background-content", part: "background" }), h(TagType, { key: "4dd2f58421493f7a4ca42f8f5d7b85cda8e320ea", class: {
      "inner-scroll": true,
      "scroll-x": scrollX,
      "scroll-y": scrollY,
      overscroll: (scrollX || scrollY) && forceOverscroll
    }, ref: (scrollEl) => this.scrollEl = scrollEl, onScroll: this.scrollEvents ? (ev) => this.onScroll(ev) : void 0, part: "scroll" }, h("slot", { key: "37904f8f1d8319156cd901feb21930ef674fe0f7" })), transitionShadow ? h("div", { class: "transition-effect" }, h("div", { class: "transition-cover" }), h("div", { class: "transition-shadow" })) : null, h("slot", { key: "8f696583903af0548d064dca1a6bae060e127485", name: "fixed" }));
  }
  get el() {
    return getElement(this);
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-37a22d34-4NB6HXVZ.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-CJKEZ6US.js.map
