...
// Persists collapsed/expanded state for a section. Any track member.
// Deliberately does NOT bump content_updated_at — collapse toggles are UI noise
// and would force needless full refetches on every other member's screen.

'use strict';

const { supabase } = require('../db');
const { assertSectionAccess } = require('../track_access');
