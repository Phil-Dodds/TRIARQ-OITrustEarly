...
var IonDatetimeButtonIosStyle0 = iosDatetimeButtonCss;
...
var IonDatetimeButtonMdStyle0 = mdDatetimeButtonCss;
var DatetimeButton = class {
  ...
  render() {
    ...
    }) }, dateText && h("button", { key: "cbda6f3386c3714567a04b5a97a96c71d59822c8", class: "ion-activatable", id: "date-button", "aria-expanded": datetimeActive ? "true" : "false", onClick: this.handleDateClick, disabled, part: "native", ref: (el) => this.dateTargetEl = el }, h("slot", { key: "a00ff431512827bfef8c02982ef37099b2f21508", name: "date-target" }, dateText), mode === "md" && h("ion-ripple-effect", { key: "67935989628a2ed0492edb813fb0475bfd88abe7" })), timeText && h("button", { key: "4207c94de5bece91b8388332e0192d1756403e62", class: "ion-activatable", id: "time-button", "aria-expanded": datetimeActive ? "true" : "false", onClick: this.handleTimeClick, disabled, part: "native", ref: (el) => this.timeTargetEl = el }, h("slot", { key: "9ffa7ef4417571933bd1757950ec805c49704759", name: "time-target" }, timeText), mode === "md" && h("ion-ripple-effect", { key: "fbcad00cf828c9719074d1d06f4e13246b28903e" })));
  }
  get el() {
...
@ionic/core/dist/esm/ion-datetime-button.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-datetime-button.entry-LM72WZL3.js.map
