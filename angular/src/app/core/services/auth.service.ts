...
export class AuthService {
  ...
  // Contract 17 §2 / D-380, D-381: screen-state read/write moved off this
  // service. AuthService no longer touches user_screen_state. All callers go
  // through ScreenStateService, which calls division-mcp get_user_screen_state
  // and upsert_user_screen_state. The Contract 16 direct-Supabase methods were
  // an Arch-1 violation — Design ruled the "RLS handles it" rationalization is
  // architecturally unsound and the D-171 citation in migration 032 was wrong.
  // See Contract 17 CodeClose for the full ruling.
}
