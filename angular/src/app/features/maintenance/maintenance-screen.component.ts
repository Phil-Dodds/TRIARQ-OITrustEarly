...
// Pathways OI Trust | D-MaintenanceMode | AC-29
//
// Standalone component. No auth dependency. No MCP calls. No routing elements.
// Rendered by AppComponent when system_config.maintenance_mode = true.
//
// Rescued verbatim 2026-07-30 from an orphaned Build C worktree and reused
// as-is in Contract 42 — it carries no dependency that has moved since.
