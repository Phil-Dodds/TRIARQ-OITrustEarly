...
// src/main.ts
initFederation().catch((err) => console.error("[OI Trust] Federation init error:", err)).then(() => import("./bootstrap-NVR3DFLG.js")).catch((err) => console.error("[OI Trust] Bootstrap error:", err));
