...
Developers can dismiss this warning by removing their usage of the "legacy" property and using the new range syntax.`, this.el);
  ...
  renderRange() {
    ...
    }, part: "label" }, label !== void 0 ? h("div", { class: "label-text" }, label) : h("slot", { name: "label" })), h("div", { class: "native-wrapper" }, h("slot", { name: "start" }), this.renderRangeSlider(), h("slot", { name: "end" }))));
  }
  get hasLabel() {
...
@ionic/core/dist/esm/ion-range.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-range.entry-GQTEOX2N.js.map
